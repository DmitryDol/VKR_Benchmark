...
- **Целевой порог:** лучший квантованный конфиг модели должен укладываться в **2.0%**
...
стадии 1** и переиспользует на стадиях 2–6:
...
C++-расширение), выводится предупреждение, а значения могут быть занижены.
