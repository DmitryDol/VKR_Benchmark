...
### Числовой результат — mAP и latency

| Стадия | mAP_50:95 | mAP_50 | Latency | Engine size | Δ vs Stage 1 (0.5595) |
|--------|----------:|-------:|--------:|------------:|----------------------:|
| `1_pytorch_fp32` (baseline) | 0.5595 | 0.7440 | 36.14 ms | 129.4 MB | — |
| `4_trt_fp16` (reference) | 0.5595 | 0.7438 | 10.20 ms | 62.4 MB | ±0 |
| `5_trt_int8_entropy` | 0.5596 | 0.7438 | 10.89 ms | 62.5 MB | **+0.0001** |
| `5_trt_int8_minmax` | 0.5590 | 0.7434 | 10.72 ms | 62.4 MB | -0.0005 |
| `5_trt_int8_percentile` | 0.5592 | 0.7436 | 11.58 ms | 62.5 MB | -0.0003 |

> Все Stage 5 значения **численно совпадают** со Stage 4 FP16 — что прямо подтверждает,
> что движок собран фактически как FP16 несмотря на установленный `BuilderFlag.INT8`.
